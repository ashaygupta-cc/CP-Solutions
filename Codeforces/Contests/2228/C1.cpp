...
void ZodiacZ408(){
  ...
  read(i,0,l){
      ...
      if(d[1] < curReq) take = d[1];
      else if(d[0] < curReq) take = d[0];
      ...
      if(d[0] > curReq) take = d[0];
      else if(d[1] > curReq) take = d[1];

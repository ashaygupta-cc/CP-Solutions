...
vector<ll>s;
 
ll solve(ll l,ll h,ll n,vector<ll>& a){
...
void ZodiacZ408(){
    ...
    maxi = max(maxi,solve(zeros[0],zeros[0],n,a));
    maxi = max(maxi,solve(zeros[1],zeros[1],n,a));
    maxi = max(maxi,solve(zeros[0],zeros[1],n,a));
